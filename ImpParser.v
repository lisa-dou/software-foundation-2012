...
Definition classifyChar (c : ascii) : chartype :=
  if isWhite c then 
    ...
    other.
Compute classifyChar "a"%char.
Compute classifyChar "5"%char.
Compute classifyChar "$"%char.
Compute classifyChar " "%char.
...
Compute string_of_list ["a"%char, "b"%char, "c"%char].
...
Compute tokenize_helper white [] ["a"%char, "b"%char, "5"%char,"6"%char, "c"%char,"a"%char].
Compute tokenize_helper white [] ["("%char, "s"%char, ")"%char].
Compute tokenize_helper white ["a"%char, "b"%char] ["c"%char, "5"%char, ")"%char].
Compute tokenize_helper alpha ["a"%char, "b"%char] ["c"%char, "5"%char, ")"%char].
Compute tokenize_helper digit ["a"%char, "b"%char] ["a"%char, "5"%char, ")"%char].
Compute tokenize_helper digit ["1"%char, "2"%char] ["a"%char, "5"%char, ")"%char].
Compute tokenize_helper digit ["1"%char, "2"%char] ["5"%char, "a"%char, "6"%char].
...
Compute tokenize_helper white []  (list_of_string "abc12==3  223*(3+(a+c))" %string).
...
Compute build_symtable (["abc", "ff"]) 1 "abc".
Compute build_symtable (["abc", "ff"]) 1 "ff".
Compute build_symtable (["abc", "Ff","lala"]) 1 "Ff".
Compute build_symtable (["abc", "Ff","lala"]) 1 "lala".
Compute build_symtable (["abc", "ff"]) 1 "sss".
